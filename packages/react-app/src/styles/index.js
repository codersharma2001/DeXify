const styles = {
  ...
  headTitle: "text-white font-Proxima Nova font-black text-6xl tracking-wide",
  subTitle: "text-dim-white font-Proxima Nova font-medium mt-3 text-base",
  exchangeBoxWrapper: "mt-10 w-full flex justify-center",
  exchangeBox:
    "relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full bg-gradient-to-r from-purple-500 p-[2px]  to-green-500 rounded-3xl",
  exchange:
    "w-full min-h-[400px] bg-slate-950 backdrop-blur-[4px] rounded-3xl shadow-card flex p-10",
  ...
  // WalletButton
  walletButton:
    "bg-black border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-green-600 transition-all",
